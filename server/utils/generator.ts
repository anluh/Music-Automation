...
export const createGenerations = (workflowId: number, count: number, settings: any) => {
    const { mood, stylePrompt, tags, weirdnessMin, weirdnessMax, bpmMin, bpmMax, styleInfluenceMin, styleInfluenceMax, vocalGender, isInstrumental, negativeTags } = settings
    ...
    INSERT INTO generations (workflow_id, mood, style_prompt, weirdness_min, weirdness_max, bpm_min, bpm_max, style_influence_min, style_influence_max, vocal_gender_probability, is_instrumental, negative_tags, status)
